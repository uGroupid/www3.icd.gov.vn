						...
						<div class="span">
							<div class="news_hot_catelogy_list_pages" style="margin-bottom: 34px; width: 100%; float: left; border-bottom: 2px solid rgb(233, 233, 233) ! important;">
								...
								<?php foreach($data_getcontent_category as $value_data_getcontent_category){}?>
								 <?php $url = to_slug($value_data_getcontent_category['title_video']);?>
								...
								<div class="img_news_hot_catelogy_list_pages"> 
									...
									<div class="span4">
										...
										<a href="<?php echo base_url();?>details/video/<?php echo $value_data_getcontent_category['id']; ?>/<?php echo $titlecs; ?>/<?php echo $url; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_data_getcontent_category['title_video']; ?>"> <h3 class="news_hot_catelogy_list_pages_h3">	
										<?php echo $value_data_getcontent_category['title_video']; ?> </h3></a>
									</div>
								</div>
								...
								<div class="content_li_list_wp_list_container_left">
									...
									<div class="content_list_content_pages">
									  <h3 class="text_headering_home_list" style="line-height: 24px ! important;" >
										<a href="<?php echo base_url();?>details/video/<?php echo $value_content_list['id']; ?>/<?php echo $titlecs; ?>/<?php echo $urls; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_content_list['title_video']; ?>"><span ><?php echo $value_content_list['title_video']; ?></span> </a>
									  </h3>
									  <div class="title_v1_home">
										<h5 class="title_home_center_layout3"> <?php echo $value_content_list['introduction']; ?>... </h5>
										<a href="<?php echo base_url();?>details/video/<?php echo $value_content_list['id']; ?>/<?php echo $titlecs; ?>/<?php echo $urls; ?>/<?php echo $iddanhmuc; ?>.icd" title="<?php echo $value_content_list['title_video']; ?>"> 
											[xem tiếp]
										</a>
									  </div>
									</div>
