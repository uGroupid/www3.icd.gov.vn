            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo base_url();?>dashboard/profile"><i class="fa fa-user fa-fw"></i> Thông Tin Cá Nhân</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url();?>dashboard/logout"><i class="fa fa-sign-out fa-fw"></i> Thoát Tài Khoản</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                    ...
                    <ul class="nav" id="side-menu">
                                 ...
                                 <li>
                                      ...
                                      <ul class="nav nav-second-level">
                                        ...
                                        <li>
                                          ...
                                          <a href="<?php echo base_url();?>dashboard/UPCOMING_EVENTS"><i class="fa fa-minus-circle"></i> SỰ KIỆN SẮP DIỄN RA</a>
                                        </li>
                                      </ul>
                                      <!-- /.nav-second-level -->
                                  </li> 
                                   ...
                                   <li>
                                      <a href="<?php echo base_url();?>dashboard/document"><i class="fa fa-minus-circle"></i> Quản Trị Văn bản Tư Liệu</a>
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url();?>dashboard/user_profile"><i class="fa fa-group"></i> Danh Sách Tài Khoản</a>
                                </li> 
                        ...
                        <?php }?>
                        <li>
                            <a href="<?php echo base_url();?>dashboard/logout"><i class="fa fa-sign-in"></i> Đăng xuất</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
