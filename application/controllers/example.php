...
class Example extends CI_Controller
{
	...
	{
		$params['key'] = 'AIzaSyBXyERC_Px0zfuKbFAcR8FUcxFyVCt5vsA';
		$params['secret'] = 'sFnkPXeDC55gTTxGsEQ85o9r';
	...
	public function youtube_no_auth()
	{
		...
		$client = new Youtube();
		echo client->getKeywordVideoFeed('pac man');
	}
	...
	{
		$params['apikey'] = 'AI39si63kj6Tvvbl0gB8gc48kqcqRPSLeQFkNYejxJO08TTH_NASlRudIVOLNEKtpYbitBxruitc-gtJ2pFhFdFEsrQKgEKMDg';
		$params['oauth']['key'] = 'AIzaSyBXyERC_Px0zfuKbFAcR8FUcxFyVCt5vsA';
		$params['oauth']['secret'] = 'sFnkPXeDC55gTTxGsEQ85o9r';
