...
{
    // default connection
    public static $dbname = 'c121dbvhtt'; // Your database name
    public static $dbuser = 'c121vhtt'; // Your database username
    public static $dbpass = '123123fF'; // // Your database password
