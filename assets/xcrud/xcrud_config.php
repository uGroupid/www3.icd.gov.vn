...
{
    // default connection
 public static $dbname = 'c0icdgov'; // Your database name
    public static $dbuser = 'c0icdgov'; // Your database username
    public static $dbpass = '11223344fF'; // // Your database password
    ...
    // editor
    public static $editor_url = '/assets/xcrud/tinymce/tinymce.min.js';
